...
mod_norm_logtrans_trait_student<-
  brm(log(Value) | se(Standard.Deviation/sqrt(Sample.Size)) # log of mean ES to normalize, |se() weights the on standard error of measurment (convention for meta-analysis)
