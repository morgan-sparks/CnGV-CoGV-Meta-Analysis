...
### load in data
#model data
real_model_data_trait <-  read.csv("/scratch/bell/sparks35/CNGV_analysis/data/cogv_model_data.csv")
...
saveRDS(mod_norm_logtrans_trait_co, "mod_norm_logtrans_trait_2randeff_student_co_sp.rds")
