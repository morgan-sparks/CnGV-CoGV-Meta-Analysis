...
### load in data
#model data
real_model_data_trait <-  read.csv("/scratch/bell/sparks35/CNGV_analysis/data/cngv_model_data.csv")
...
saveRDS(mod_norm_logtrans_trait, "mod_norm_logtrans_trait_2randeff_student.rds")
